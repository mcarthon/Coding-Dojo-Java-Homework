package loginAndRegistration.services;
...
import loginAndRegistration.repositories.UserRepository;
...
public class UserService {
	...
	public User register ( User newUser, BindingResult bindingResult ) {
		...
		if ( this.userRepository.findByUserName( newUser.getUserName() ).isPresent() ) {
			...
			bindingResult.rejectValue ( "userName", "Not Unique", "This username has already been taken. " );
